...
Theta1 = 50; %% Referencia de umbralizaci�n 1
...
% Operaciones para par 1 de imagenes Theta 1
...
figure;
subplot(3, 3, 1); imagesc(iop1_1), title('Substraccion entre imagenes I1-1 - I1-2');
subplot(3, 3, 2); imagesc(mov1_1), title('Umbralizacion entre imagenes I1-1 - I1-2');
subplot(3, 3, 3); imagesc(movDetectado1_1), title('Movimiento detectado entre imagenes I1-1 - I1-2');

subplot(3, 3, 4); imagesc(iop1_2), title('Operacion OR entre imagenes I1-1 - I1-2');
subplot(3, 3, 5); imagesc(mov1_2), title('Umbralizacion entre imagenes I1-1 - I1-2');
subplot(3, 3, 6); imagesc(movDetectado1_2), title('Movimiento detectado entre imagenes I1-1 - I1-2');

subplot(3, 3, 7); imagesc(iop1_3), title('Operacion AND entre imagenes I1-1 - I1-2');
subplot(3, 3, 8); imagesc(mov1_3), title('Umbralizacion entre imagenes I1-1 - I1-2');
subplot(3, 3, 9); imagesc(movDetectado1_3), title('Movimiento detectado entre imagenes I1-1 - I1-2');



% Operaciones para par 2 de imagenes Theta 1
...
figure;
subplot(3, 3, 1); imagesc(iop2_1), title('Substraccion entre imagenes I2-1 - I2-2');
subplot(3, 3, 2); imagesc(mov2_1), title('Umbralizacion entre imagenes I2-1 - I2-2');
subplot(3, 3, 3); imagesc(movDetectado2_1), title('Movimiento detectado entre imagenes I2-1 - I2-2');

subplot(3, 3, 4); imagesc(iop2_2), title('Operacion OR entre imagenes I2-1 - I2-2');
subplot(3, 3, 5); imagesc(mov2_2), title('Umbralizacion entre imagenes I2-1 - I2-2');
subplot(3, 3, 6); imagesc(movDetectado2_2), title('Movimiento detectado entre imagenes I2-1 - I2-2');

subplot(3, 3, 7); imagesc(iop2_3), title('Operacion AND entre imagenes I2-1 - I2-2');
subplot(3, 3, 8); imagesc(mov2_3), title('Umbralizacion entre imagenes I2-1 - I2-2');
subplot(3, 3, 9); imagesc(movDetectado2_3), title('Movimiento detectado entre imagenes I2-1 - I2-2');


% Operaciones para par 3 de imagenes Theta 1
...
figure;
subplot(3, 3, 1); imagesc(iop3_1), title('Substraccion entre imagenes I3-1 - I3-2');
subplot(3, 3, 2); imagesc(mov3_1), title('Umbralizacion entre imagenes I3-1 - I3-2');
subplot(3, 3, 3); imagesc(movDetectado3_1), title('Movimiento detectado entre imagenes I3-1 - I3-2');

subplot(3, 3, 4); imagesc(iop3_2), title('Operacion OR entre imagenes I3-1 - I3-2');
subplot(3, 3, 5); imagesc(mov3_2), title('Umbralizacion entre imagenes I3-1 - I3-2');
subplot(3, 3, 6); imagesc(movDetectado3_2), title('Movimiento detectado entre imagenes I3-1 - I3-2');

subplot(3, 3, 7); imagesc(iop3_3), title('Operacion AND entre imagenes I3-1 - I3-2');
subplot(3, 3, 8); imagesc(mov3_3), title('Umbralizacion entre imagenes I3-1 - I3-2');
subplot(3, 3, 9); imagesc(movDetectado3_3), title('Movimiento detectado entre imagenes I3-1 - I3-2');

% Operaciones para par 4 de imagenes Theta 1
...
figure;
subplot(3, 3, 1); imagesc(iop4_1), title('Substraccion entre imagenes I4-1 - I4-2');
subplot(3, 3, 2); imagesc(mov4_1), title('Umbralizacion entre imagenes I4-1 - I4-2');
subplot(3, 3, 3); imagesc(movDetectado4_1), title('Movimiento detectado entre imagenes I4-1 - I4-2');

subplot(3, 3, 4); imagesc(iop4_2), title('Operacion OR entre imagenes I4-1 - I4-2');
subplot(3, 3, 5); imagesc(mov4_2), title('Umbralizacion entre imagenes I4-1 - I4-2');
subplot(3, 3, 6); imagesc(movDetectado4_2), title('Movimiento detectado entre imagenes I4-1 - I4-2');

subplot(3, 3, 7); imagesc(iop4_3), title('Operacion AND entre imagenes I4-1 - I4-2');
subplot(3, 3, 8); imagesc(mov4_3), title('Umbralizacion entre imagenes I4-1 - I4-2');
subplot(3, 3, 9); imagesc(movDetectado4_3), title('Movimiento detectado entre imagenes I4-1 - I4-2');

% Operaciones para par 5 de imagenes Theta 1
...
figure;
subplot(3, 3, 1); imagesc(iop5_1), title('Substraccion entre imagenes I5-1 - I5-2');
subplot(3, 3, 2); imagesc(mov5_1), title('Umbralizacion entre imagenes I5-1 - I5-2');
subplot(3, 3, 3); imagesc(movDetectado5_1), title('Movimiento detectado entre imagenes I5-1 - I5-2');

subplot(3, 3, 4); imagesc(iop5_2), title('Operacion OR entre imagenes I5-1 - I5-2');
subplot(3, 3, 5); imagesc(mov5_2), title('Umbralizacion entre imagenes I5-1 - I5-2');
subplot(3, 3, 6); imagesc(movDetectado5_2), title('Movimiento detectado entre imagenes I5-1 - I5-2');

subplot(3, 3, 7); imagesc(iop5_3), title('Operacion AND entre imagenes I5-1 - I5-2');
subplot(3, 3, 8); imagesc(mov5_3), title('Umbralizacion entre imagenes I5-1 - I5-2');
subplot(3, 3, 9); imagesc(movDetectado5_3), title('Movimiento detectado entre imagenes I5-1 - I5-2');

% Guardando Imagenes 1
